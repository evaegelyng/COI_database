...
my $newtaxid = 000000; # Added to allow the use of taxizedb for classification instead of the MARES taxonomy. This line will make a fixed dummy taxid for all taxa not found in the NCBI taxonomy
