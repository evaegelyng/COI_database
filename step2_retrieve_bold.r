...
#taxlist<-readLines("taxlist_bold.txt")
#taxlist<-readLines("taxlist_bold_arthropoda.txt")
#taxlist<-readLines("taxlist_bold2.txt")
taxlist<-readLines("taxlist_bold_diptera.txt")
