#!/home/evaes/miniconda3/envs/myenv.3/bin/perl

#Before running, activate the conda environment myenv.3
# conda activate myenv.3
#Make a directory for the output and run the script directly from there, without sending to queue (apparently URL percent codes are not decoded when sent to SLURM):
# mkdir -p taxaNCBI
# cd taxaNCBI
# perl ../scripts/coi_ret/ebot_taxonomy3.plx
...
$params{email} = "eva.sigsgaard@bio.au.dk"; ### Put your email address here ###
$params{db} = "taxonomy";
$params{tool} = "ebot";
#$params{term} = $ARGV[0];
$params{term} = "%22eukaryota%22[ORGN]+AND+species[RANK]";  # Eva removed ref to taxa.list_ebot
%params = esearch(%params);

#$params{outfile} = "taxonomy.taxid".$ARGV[1];
$params{outfile} = "taxonomy.taxid";  # Eva removed ref to taxa.list_ebot
